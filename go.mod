...
require (
	...
	github.com/docker/distribution v2.4.1+incompatible // indirect
	...
	github.com/gopherjs/gopherjs v0.0.0-20170427215411-9659c814f1d5 // indirect
	...
	github.com/jessevdk/go-flags v0.0.0-20160227093438-6b9493b3cb60
